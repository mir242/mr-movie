...
export default function MovieCard({ img }) {
    return (
        <div className='bg-gray-400 aspect-[2/3] relative  rounded-l  overflow-hidden'>
            ...
            <div className='flex flex-col justify-end absolute bottom-0 left-0 right-0 w-full h-full p-8 bg-gradient-to-b from-[#1e0b372c] to-[#123632d6] hover:from-[#0e0b376f] to-[#275741f6]  '>
                <h3>die hard</h3>
